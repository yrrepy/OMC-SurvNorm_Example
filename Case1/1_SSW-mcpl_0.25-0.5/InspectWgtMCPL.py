...
for p in mcplfile.particles:
    ...
    if pp == 2112: 
        ...
        pcount     += 1           # Count Neutrons
        ptotweight += p.weight    # Sum   Photon Weight
...
print("-------------------------");
print("Photon        Count  = ",pcount);
print("Photon  Total Weight = ",ptotweight);
print("Photon  Avg.  Weight = ",ptotweight/pcount);
print("  ");
print("  ");