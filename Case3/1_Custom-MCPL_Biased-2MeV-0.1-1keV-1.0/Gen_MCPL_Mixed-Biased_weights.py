...
mcplfile = mcpl.MCPLFile("surface_source.mcpl")
...
for p in mcplfile.particles:
     ...
     t      = 0
     if pp==2112:                           # Neutrons
         weight = 0.1                       # adjust neutron weight  
         energy = 2.0 
...
# 
# 
np2mcpl.save(f'surface_source.2MeV-0.1.mcpl',MCPLArray)
...
for p in mcplfile.particles:
     ...
     t      = 0.00
     if pp==2112:                           # Neutrons
         weight = 1.0                      # adjust neutron weight  
         energy = 0.001 
     MCp = (pp,x,y,z,ux,uy,uz,t,energy,weight) 
#    print(MCp)
...
# 
# 
np2mcpl.save(f'surface_source.1keV-1.0.mcpl',MCPLArray2)
